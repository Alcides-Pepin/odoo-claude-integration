#!/usr/bin/env python3
"""
Odoo MCP Server - Official SDK Implementation

This server provides Odoo integration tools using the official MCP Python SDK
with built-in OAuth and HTTP transport support.
"""
import os
import sys
import asyncio
